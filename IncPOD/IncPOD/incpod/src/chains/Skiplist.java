...
//	public  List<Integer> getvalue(int key1, int key2) {
//		skiplistnode p;
//		p=find(key1).right;
//		if(p.key1==key1&&p.key2==key2) {return p.value;}
//		else return null;
//	}
	
	
	public int checkinsert(int key1, int key2, int value,int flag,int type) {
		//System.out.println(n+" "+key1+" "+key2+" "+type+" "+flag);
		...
		if(type==0) {
		//	System.out.println(n+" "+p.key1+" "+p.key2);
